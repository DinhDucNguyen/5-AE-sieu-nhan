namespace WebBanHangOnline.Migrations
{
    ...
    public partial class CreatedDatabase : DbMigration
    {
        ...
        .PrimaryKey(t => t.Id)
        .ForeignKey("dbo.tb_ProductCategory", t => t.ProductCategoryId, cascadeDelete: true)  // Thêm khóa ngoại
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_Product", "ProductCategoryId", "dbo.tb_ProductCategory");  // Xóa khóa ngoại
            DropIndex("dbo.tb_Product", new[] { "ProductCategoryId" });  // Xóa chỉ mục
